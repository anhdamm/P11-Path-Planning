...
//                                                             closest_leftfront_dist);// find the minimal distance to the closest rightfront car
              ...
              else if (others_lane == my_lane + 1) { //right lane
                  ...
                  if (dist > 0) {
                      ...
                      // find the minimal distance to the closest leftback car
          ...
          if ((decision == 0) or (decision == -1)) { // continue
              ...
              // Avoid other cars that might hit our car when they change lanes(car width ~ 3 m)
              ...
              if (car_crash) { 
                  ...
                  if (ref_vel - closest_front_vec>0) { 
                      // decelerate
                      speed_diff -= MAX_ACC;
                  } 
                  
                  else {
                      // if front car speed higher than my car, keep the car speed to follow the front car
                      speed_diff -= 0.0;
                  }
              }
          ...
          for (int i = 1; i < 50 - prev_size; i++) {
              ...
              if (ref_vel > MAX_SPEED) {
                  // if exceed max speed, keep it at max speed
                  ref_vel = MAX_SPEED;
              } 
